...
export default function Login(){
 ...
 return <main className={styles.page}><div className={styles.glow}/><header><Link href="/" className={styles.logo}><span>R</span> Rivu<span>ai</span></Link><span className={styles.secure}><ShieldCheck size={15}/> Secure workspace</span></header>
