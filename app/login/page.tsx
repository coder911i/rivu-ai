...
export default function Login(){
 ...
 return <main className={styles.page}><div className={styles.grid}/><div className={`${styles.orbit} ${styles.orbitA}`} /><div className={`${styles.orbit} ${styles.orbitB}`} /><div className={styles.dataVisual} aria-hidden="true"><div className={styles.visualCore}><span/><span/><span/></div><i/><i/><i/><b>RIVU<br/><small>DATA INTELLIGENCE</small></b></div><header><BrandLogo href="/" className={styles.logo}/><span className={styles.secure}><ShieldCheck size={15}/> Authenticated data workspace</span></header>
